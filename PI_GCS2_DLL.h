...
long 	PI_FUNC_DECL	PI_ConnectRS232(long nPortNr, long nBaudRate);
#ifndef WIN32
...
BOOL PI_FUNC_DECL PI_qSPA_String(long ID, const char* szAxes, unsigned int* iParameterArray, char* szStrings, int iMaxNameSize);
